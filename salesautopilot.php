...
class salesAutopilot {		
	...
	function __construct($nl_id, $ns_id, $username, $password, $ssl=false) {	
...
// ADDING NEW SUBSCRIBERS
	...
	public function subscribe($fields) { // OK
...
// UPDATING A SUBSCRIBER
	...
	public function updateById($id, $fields = NULL) {
...
// $field_name = Name of the field that is used to identify the updated subscribers.
	...
	public function updateByField($field_name, $field_value, $fields = NULL) {
...
// UNSUBSCRIBING A SUBSCRIBER	
	...
	public function unsubscribeByField($field_name, $field_value) { // not in the documentation, but it works! Tested!
...
// RECEIVING WEBSHOP ORDER
	...
	public function processWebshopOrder($fields) {
